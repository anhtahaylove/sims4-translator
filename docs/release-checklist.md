...
```powershell
powershell -NoProfile -ExecutionPolicy Bypass -File scripts\check_release.ps1 -Version 2.2.13
```
...
`Release Build` workflow manually with a version such as `2.2.13`, or push a
...
```powershell
powershell -NoProfile -ExecutionPolicy Bypass -File scripts\package_release.ps1 -Version 2.2.13 -Force
```
...
```powershell
powershell -NoProfile -ExecutionPolicy Bypass -File scripts\collect_false_positive_evidence.ps1 -Version 2.2.13
```
...
- `scripts\verify_version_sync.py --version 2.2.13` should pass before tagging.
- `scripts\verify_interface_i18n.py --all --version 2.2.13 --strict-empty --strict-missing` should pass before release packaging.
