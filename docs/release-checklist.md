...
```powershell
powershell -NoProfile -ExecutionPolicy Bypass -File scripts\check_release.ps1 -Version 2.0.6
```
...
`Release Build` workflow manually with a version such as `2.0.6`, or push a
...
```powershell
powershell -NoProfile -ExecutionPolicy Bypass -File scripts\package_release.ps1 -Version 2.0.6 -Force
```
...
```powershell
powershell -NoProfile -ExecutionPolicy Bypass -File scripts\collect_false_positive_evidence.ps1 -Version 2.0.6
```
...
- `scripts\verify_version_sync.py --version 2.0.6` should pass before tagging.
- `scripts\verify_interface_i18n.py --language vi_VN --version 2.0.6` should pass before release packaging.
