...
class Ui_OptionsDialog(object):
    ...
    def build_general_tab(self):
        ...
        layout_deepl_actions.addWidget(self.btn_gemini_test)
        layout_deepl_actions.addWidget(self.btn_openai_test)
        layout_deepl_actions.addStretch()
        layout_deepl_actions.addWidget(self.btn_ollama_refresh)
        layout_deepl_actions.addWidget(self.btn_ollama_test)
        ...
        layout_deepl.addWidget(self.txt_gemini_key)
        layout_deepl.addWidget(self.txt_gemini_model)
        layout_deepl.addWidget(self.txt_openai_key)
        layout_deepl.addWidget(self.txt_openai_base_url)
        layout_deepl.addWidget(self.txt_openai_model)
        layout_deepl.addWidget(self.cb_ollama_enabled)
        layout_deepl.addWidget(self.txt_ollama_base_url)
        layout_deepl.addWidget(self.cb_ollama_model)
        layout_deepl.addWidget(self.lbl_ollama_status)
        layout_deepl.addLayout(layout_ollama_actions)
        layout_deepl.addWidget(self.txt_ai_session_cap)
        layout_deepl.addWidget(self.txt_ai_daily_cap)
