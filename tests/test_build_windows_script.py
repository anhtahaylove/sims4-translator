...
class BuildWindowsScriptTests(unittest.TestCase):
    ...
    def test_fast_check_script_runs_clean_checkout_checks(self):
        ...
        self.assertIn('python scripts\\verify_version_sync.py --version 2.3.6', script)
        self.assertIn(
    ...
    def test_ai_provider_smoke_script_keeps_provider_keys_local(self):
        ...
        self.assertIn('DEEPL_API_KEY', script)
        self.assertIn('DEEPL_AUTH_KEY', script)
        ...
        self.assertIn('[switch]$DeepL', script)
        self.assertIn('[switch]$Ollama', script)
        self.assertIn('deepl_usage', script)
        self.assertIn('without spending translation characters', script)
    ...
    def test_false_positive_docs_are_linked_from_public_trust_surfaces(self):
        ...
        self.assertIn('Microsoft file submission portal', doc)
        self.assertIn('SecureAge false-positive form', doc)
        self.assertIn('Current v2.3.0 Review Targets', doc)
        self.assertIn('Cylance, Microsoft Defender, and APEX', doc)
        self.assertIn('Microsoft Defender', doc)
