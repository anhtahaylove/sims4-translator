...
class BuildWindowsScriptTests(unittest.TestCase):
    ...
    def test_fast_check_script_runs_clean_checkout_checks(self):
        ...
        self.assertIn('python scripts\\verify_version_sync.py --version 2.2.1', script)
        self.assertIn(
            'python scripts\\verify_interface_i18n.py --language vi_VN --version 2.2.1 --strict-empty --strict-missing',
            script,
        )
