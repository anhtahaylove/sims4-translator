...
| Dùng dịch máy | Cấu hình DeepL, Google hoặc MyMemory, có kiểm tra quota và cảnh báo chi phí DeepL trước batch lớn. |
...
![Ảnh Validate Release](docs/assets/readme/validate-release.png)
...
DeepL là tùy chọn. Không có DeepL key thì bạn vẫn dùng app bình thường.

Cách dùng:

1. Mở **Tùy chọn**.
2. Dán **DeepL API key**.
3. Bấm **Test key** để kiểm tra key.
